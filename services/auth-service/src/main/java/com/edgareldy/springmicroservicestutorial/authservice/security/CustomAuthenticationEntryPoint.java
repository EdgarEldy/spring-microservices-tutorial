 ...
 * an unauthenticated request hits a protected endpoint. The controller-level
 * exception handler only sees exceptions thrown inside a controller method;
 * a missing/invalid JWT is rejected earlier, in the security filter chain,
 * where this entry point runs instead.
 * <p>
