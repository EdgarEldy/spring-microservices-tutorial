 ...
 * {@code auth-service}/{@code catalog-service}'s class of the same name
 * rather than shared via {@code common-lib}: this class depends on Spring
 * Security types tied to this service's own filter chain wiring, and
 * {@code common-lib} never holds code specific to one service's security
 * configuration.
 * <p>
