 ...
 * same shared HMAC secret. Duplicated from {@code catalog-service}'s class
 * of the same name (not shared via {@code common-lib}, see that class'
 * Javadoc for why) rather than reused directly. Like {@code
 * catalog-service}, this one never signs a token: {@code customer-service}
